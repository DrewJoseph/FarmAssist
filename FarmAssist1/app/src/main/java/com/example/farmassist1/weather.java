...
//working ends
                ...
                // = ja.getJSONObject(2);
                String str1=ja.getString(0);
               // String str=ja.getString("description");
                //t16.setText("Description: "+ja.getString(0));
               t16.setText("Description:"+str1);
...
//                t23.setText("Wind Direction: 128 deg");
                ...
                JSONObject jobject1=jobject.getJSONObject("main");
                String str=jobject1.getString("temp");
                ...
                jobject1=jobject.getJSONObject("main");
                str=jobject1.getString("humidity");
             ...
             //   temp
//                jotemp=jobject.getJSONObject("main");
//
//                t=jotemp.getString("temp");
//                ftemp=Float.parseFloat(t);
//                dtemp=ftemp-273.15;
//                System.out.println(" Received Temperature "+dtemp);
